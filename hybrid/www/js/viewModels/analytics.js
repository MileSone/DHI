...
define(['ojs/ojcore', 'knockout', 'masonry', 'jquery', 'mbe/mbe', 'libs/bower_components/imagesloaded/imagesloaded', 'data/gloableVars', 'mcs', 'mcs_config', 'ojs/ojbutton'
    ...
    function SuppliersViewModel() {
        ...
        var self = this;
        'use strict';
        var AcitivityFileID = "FD681C6DCF63D58B92EC4CB5F8991C9FEFA4D18A5DD0";
        var mainUrl = "https://documents-gse00002643.sites.us2.oraclecloud.com/bmw/activities.html";
        var heroContainer;
        var heroMasonry;
        ...
        self.init = function () {
            ...
            // setter, specifying both icons:demo-refresh-icon

            //get images
            if (firstTimeInitializeAcitivity) {
                imagetracker = 1;
                self.showImageIDs(AcitivityFileID);
                firstTimeInitializeAcitivity = false;
            } else {
                $('#statusTitle').hide(0);
                self.getExamples(activityType);
            }
        };
        ...
        self.refreshData = function () {
            $(".has-example").empty();   
            $(".has-example").remove();
            firstTimeInitializeAcitivity = true;
            self.init();
        };
...
//            return imageUrl;
        ...
        self.openURL = function () {
            ...
            var options = "clearcache=no,clearsessioncache=no,location=no";
            var ref = cordova.InAppBrowser.open(mainUrl, '_blank', '');
        };
        //**blob to dataURL**
